...
The master branch tracks my problem-solving progress, so the lab source code is modified.

The lab branch keeps the original lab source code, you can get start from this branch.
